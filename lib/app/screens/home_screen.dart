...
class _HomeScreenState extends ScreenState<HomeScreen> {
  ...
  Widget builder(BuildContext context) {
    return WillPopScope(
        ...
        child: Bucket(
            enableBucketDragGesture: true,
            child: Scaffold(
                appBar: AppBar(
                  backgroundColor: Style.dashboardSelectedMenu,
                  elevation: 0,
                  leading: BucketActionButton(icon: AnimatedIcons.menu_close),
                ),
                body: Container(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          Image(
                              image: AssetImage('assets/karee.png',
                                  package: 'karee')),
                          Text(
                          ...
                          Text(
                            'Verision v2.1.0',
                            style:
                                TextStyle(fontSize: 20, color: Style.whiteText),
                          ),
                          SizedBox(height: 20),
                          ElevatedButton(
                            onPressed: () async {
                              if (await launcher
                                ...
                                await launcher
                                    .launch(KareeConstants.kareeGithub);
                              }
                            },
